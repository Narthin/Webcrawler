...
public class CrawlerJUnit {
    ...
    public void crawlerTestDepth1(){
       ...
       // when(jsoupMock.getLinks(anyString(), any(PolitenessPolicy.class))).thenAnswer(
        ...
        assertEquals(graph.getNeighbors(2), new ArrayList<>(Arrays.asList()));    //C outgoing edges should be []
        assertEquals(graph.getNeighbors(3), new ArrayList<>(Arrays.asList()));    //D outgoing edges should be []
